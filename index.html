                ...
                <div class="w_h J_scrollspy mt5">
                    <div class="brand-tit">
                        ...
                        <div class="brand-tit-r">
                            <dl>
                                <dd><a href="#" target="_blank" class="">鱼油</a></dd>
                                <dd><a href="#" target="_blank" class="">巧克力</a></dd>
                                <dd><a href="#" target="_blank" class="">保健</a></dd>
                                <dd><a href="#" target="_blank" class="LETTER-RED">Adidas</a></dd>
                                <dd><a href="#" target="_blank" class="">supreme</a></dd>
                                <dd><a href="#" target="_blank" class="">Nike</a></dd>
                                <dd><a href="#" target="_blank" class="LETTER-RED">潘多拉</a></dd>
                            </dl>
                        </div>
                    </div> 
                    <ul id="J_hotSaleWrap_3" class="goodsnew_list clearfix goodsnew_list_row3">
            ...
            <div class="g-fixed-r">
                <div class="parents-care-products" id="J_pcpWrap"> 
                    <div class="reco-content-wrap">
                        <div class="reco-content-inner hidden" id="J_rcInner_1"></div>
                        <div class="reco-content-inner hidden" id="J_rcInner_2">   </div>
                    <div class="reco-content-inner hidden" id="J_rcInner_3">
                </div>    
            </div>
        </div>
    </div>
